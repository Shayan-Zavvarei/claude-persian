...
function countZWNJ(text: string): number {
 ...
 */
export function normalizeFarsi(text: string): NormalizeFarsiResult {
...
export function registerNormalizeFarsi(server: McpServer): void {
  server.registerTool(
    'normalize_farsi',
    {
