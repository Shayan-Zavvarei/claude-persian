...
const ARABIC_TO_PERSIAN_DIGITS = Array.from({ length: 10 }, (_unused, i) => [new RegExp(String.fromCharCode(0x0660 + i), 'g'), String.fromCharCode(0x06f0 + i)]);
/**
...
function removeExtraZWNJ(text) {
    return text
        .replace(/‌{2,}/g, unicode_1.ZWNJ) // collapse runs of ZWNJ
